...
Bu repoda toplam 2 ana dosya bulunmaktadır:

- `temel_fonksiyonlar_analizi.py` → Tek script dosyası
- `kisa_rapor_github_linki.docx` → Yapılan işlemleri açıklayan kısa rapor
